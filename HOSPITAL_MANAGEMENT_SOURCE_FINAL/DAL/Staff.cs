...
namespace HOSPITAL_MANAGEMENT_SOURCE.DAL
{
    public class Staff
    {
        ...
        public Staff(int staffID, int majorID, int departmentID, int roleID, string password, string firstName, string lastName, string email,
            DateTime birthDay, int gender, Int64 iCN, string address, int state, string sdt)
        {
            StaffID = staffID;
            MajorID = majorID;
        ...
        public static DataTable GetListStaff()
        {
            string sqlSelect = @"SELECT 
                ""STAFF"".STAFFID, ""DEPARTMENT"".DEPARTMENTNAME, ""MAJOR"".MAJORNAME, ""ROLE"".ROLENAME,
        ...
        public static Staff GetStaff(int staffID)
        {
            ...
            if (staffDataTable.Rows.Count > 0)
            {
                ...
                newStaff.ICN = staffDataTable.Rows[0]["ICN"] != DBNull.Value ? Convert.ToInt64(staffDataTable.Rows[0]["ICN"]) : 0;
