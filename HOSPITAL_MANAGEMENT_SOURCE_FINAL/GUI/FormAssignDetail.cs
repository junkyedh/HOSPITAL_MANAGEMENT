...
namespace HOSPITAL_MANAGEMENT_SOURCE.GUI
{
    public partial class FormAssignDetail : Form
    {
        ...
        {
            HospitalizationCertificate newHC = HospitalizationCertificate.GetHC(patientID);
        ...
        private void buttonRemoveFunction_Click_1(object sender, EventArgs e)
        {
            if (listBoxCurrentStaff.SelectedIndex != -1)
            {
                int selectedStaff = listBoxCurrentStaff.SelectedIndex;
        ...
        //// Khúc này như click nhầm. Lười xóa nên để vậy luôn
