    ...
    public partial class FormDiseaseDetail : Form
    {
        ...
        private void buttonOk_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show(Disease.GetNextDiseaseID().ToString());
                    Disease newDisease = new Disease(Disease.GetNextDiseaseID(), textBoxDiseaseName.Text, textBoxDiseaseSymptom.Text);
