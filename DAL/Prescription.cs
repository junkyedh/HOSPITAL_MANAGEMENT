...
namespace HOSPITAL_MANAGEMENT_SOURCE.DAL
{
    public class Prescription
    {
        ...
        public static int GetNextPrescriptionID()
        {
            string sqlSelect = @"SELECT MAX(PRESCRIPTIONID) + 1 AS next_billid FROM ""PRESCRIPTION""  ";
        ...
        public static DataTable GetPatientIDInPrescription(int prescriptionID)
        {
            DataTable dtPD;
            ...
            dtPD = NpgSqlResult.ExecuteQuery(sqlSelect, npgsqlParameters);
