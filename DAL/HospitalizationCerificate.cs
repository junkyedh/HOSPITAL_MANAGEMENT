...
namespace HOSPITAL_MANAGEMENT_SOURCE.DAL
{
    public class HospitalizationCertificate
    {
        ...
        {
            string sqlInsert = @"INSERT INTO ""HOSPITALIZATIONCERTIFICATE"" 
                                    (PATIENTID, STAFFID, REASON, DATE, STATE)
                                VALUES 
                                    (@PATIENTID, @STAFFID, @REASON, @DATE, @STATE);";
        ...
        public static DataTable GetListHC()
        {
            ...
            string sqlSelect = @"SELECT 
                                    ...
                                    s.LASTNAME || ' ' || s.FIRSTNAME AS ""STAFF NAME""
                                FROM 
                                    ""HOSPITALIZATIONCERTIFICATE"" h
                                JOIN 
                                    ""PATIENT"" p ON h.PATIENTID = p.PATIENTID
                                JOIN 
                                    ""STAFF"" s ON s.STAFFID = h.STAFFID;";
