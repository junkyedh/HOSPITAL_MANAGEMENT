...
namespace HOSPITAL_MANAGEMENT_SOURCE.GUI
{
    public partial class FormMaterialDetail : Form
    {
        ...
        private void bunifuButtonOK_Click(object sender, EventArgs e)
        {
            ...
            {
                bunifuSnackbar1.Show(this, "Thiếu tên vật dụng", Bunifu.UI.WinForms.BunifuSnackbar.MessageTypes.Warning, 1000, null, Bunifu.UI.WinForms.BunifuSnackbar.Positions.TopLeft);
                return;
            }
            ...
            try
            {
                if (this.UserAction == "edit")
                {
                    ...
                    DialogResult dialogResult = MessageBox.Show("Xác nhận cập nhập thông tin vật dụng", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    if (dialogResult == DialogResult.Yes)
                    {
                        if (Material.UpdateMaterial(MaterialDetail) > 0)
                        {
                            bunifuSnackbar1.Show(this, "Cập nhập thông tin vật dụng thành công", Bunifu.UI.WinForms.BunifuSnackbar.MessageTypes.Success, 1000, null, Bunifu.UI.WinForms.BunifuSnackbar.Positions.TopLeft);
                            return;
                        }
                    }
                }
                else
                {
                    ...
                    {
                        bunifuSnackbar1.Show(this, "Thêm vật dụng thành công", Bunifu.UI.WinForms.BunifuSnackbar.MessageTypes.Success, 1000, null, Bunifu.UI.WinForms.BunifuSnackbar.Positions.TopLeft);
                        return;
                    }
                }
            }
